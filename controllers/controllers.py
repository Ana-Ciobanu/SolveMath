...
async def pow_endpoint(request: PowRequest, db: Session = Depends(get_db)):
...
async def fibonacci_endpoint(request: FibonacciRequest, db: Session = Depends(get_db)):
...
async def factorial_endpoint(request: FactorialRequest, db: Session = Depends(get_db)):
